...
class TestGetGithubDeviceCode:
    ...
    async def test_returns_device_info(
...
class TestPollGithubForToken:
    ...
    async def test_returns_token_on_success(
        ...
        with (
            ...
            mock_client = mock_httpx_client_factory(mock_client_cls)
            mock_client.post.return_value = mock_httpx_response_factory(
    ...
    async def test_returns_none_on_expired_token(
        self, mock_httpx_response_factory, mock_httpx_client_factory
    ):
    ...
    async def test_returns_none_on_access_denied(
        self, mock_httpx_response_factory, mock_httpx_client_factory
    ):
    ...
    async def test_waits_on_authorization_pending(
        self, mock_httpx_response_factory, mock_httpx_client_factory
    ):
