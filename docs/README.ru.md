...
- **Wit.ai** — Бесплатный тариф с отслеживанием месячного лимита
- **Groq Whisper** — Автоматический переход при исчерпании лимита Wit.ai

### Монетизация
- **Система кредитов** — Баланс для каждого пользователя с отслеживанием использования
- **Telegram Stars** — Нативная интеграция платежей
- **Тарифы пользователей** — Free, Paid, VIP, Tester, Admin
...
- **Управление пользователями** — Добавление/удаление VIP и тестеров, пополнение кредитов через Telegram
...
| `/account`  | Баланс, кредиты и привязка WhatsApp      |
